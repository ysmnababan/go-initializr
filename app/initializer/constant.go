...
var TEMPLATE_REGISTRY = map[string]string{
	...
	"log_middleware.go":          "logger_middleware.tmpl",
	"setup.go":                   "logger_setup.tmpl",
	"filepath.go":                "filepath.tmpl",
	"otel_container.go":          "otel_container.tmpl",
	"otel-collector-config.yaml": "otel-collector-config.tmpl",
	"postgres_container.go":      "postgres_container.tmpl",
	"smtp_container.go":          "smtp_container.tmpl",
	"redis_container.go":         "redis_container.tmpl",
}
